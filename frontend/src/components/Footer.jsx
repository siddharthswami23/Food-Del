...
const Footer = () => {
  return (
    <div className="bg-gray-900 text-white py-10" id="footer">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start md:items-start space-y-10 md:space-y-0">
        <div className="md:w-1/3">
          <img src={assets.logo} alt="Logo" className="mb-6 w-32" />
          <p className="text-sm leading-relaxed w-[85%]">
